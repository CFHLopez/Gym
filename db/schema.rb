...
ActiveRecord::Schema.define(version: 20170721035204) do
  ...
  create_table "usersclases", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer  "user_id"
    t.integer  "clase_id"
  ...
  add_foreign_key "users", "usersclases", column: "usersclases_id"
  add_foreign_key "usersclases", "clases"
  add_foreign_key "usersclases", "users"
end
